class MessageParser {
  ...
  parse = (message) => {
    ...
    if (
      lowerCase.includes("lecturer") ||
      lowerCase.includes("Lesson") ||
      lowerCase.includes("Micheal") ||
      lowerCase.includes("Jack") ||
      lowerCase.includes("Maria") ||
      lowerCase.includes("Lessons") ||
      lowerCase.includes("lesson1") ||
      lowerCase.includes("LLessons1") ||
      lowerCase.includes("lessons")
    ) {
      return this.actionProvider.LecturerHandler();
    }
    if (
    ...
    if (
      lowerCase.includes("mobiles") ||
      lowerCase.includes("mobiledevelop") ||
      lowerCase.includes("mobileapp") ||
      lowerCase.includes("mobile development") ||
      lowerCase.includes("mobile app") ||
      lowerCase.includes("mobile application") ||
      lowerCase.includes("mobiledevelopment") ||
      lowerCase.includes("mobile development") ||
      lowerCase.includes("Mobiles")
    ) {
      return this.actionProvider.MobilHandler();
    }
