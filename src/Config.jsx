...
import MobilDevelopment from "./widgets/MobilDevelopment";
import LecturerDevelopment from "./widgets/LecturerDevelopment";
const botName = "Intelligent CHATBOT";
//config for chatbot
const config = {
  botName: botName,
  customStyles: {
  ...
  widgets: [
    ...
    {
      widgetName: "MobilDevelopment",
      widgetFunc: (props) => <MobilDevelopment {...props} />,
      mapStateToProps: ["MobilDevelopmentState"],
    },
    {
    ...
    {
      widgetName: "LecturerDevelopment",
      widgetFunc: (props) => <LecturerDevelopment {...props} />,
    },
    {
      widgetName: "Tools",
