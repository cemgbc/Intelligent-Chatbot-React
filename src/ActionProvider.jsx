class ActionProvider {
  ...
  WebHandler = () => {
    const messages = this.createChatBotMessage(`courses for web development:`, {
      withAvatar: true,
...
//display list using help of states array
  MobilHandler = () => {
    const messages = this.createChatBotMessage(`courses for mobil development:`, {
      withAvatar: true,
      widget: "MobilDevelopment",
    });
  ...
  SoftwareHandler = () => {
   ...
   LecturerHandler = () => {
    const messages = this.createChatBotMessage(
      `Lecturer list for Lessons:`,
      { withAvatar: true, widget: "LecturerDevelopment" }
    );
    this.addMessageToBotState(messages);
  };
